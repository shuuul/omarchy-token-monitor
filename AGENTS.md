...
- The bar shows the selected provider icon plus two remaining meters: weekly on top, session underneath. Do not put the provider name or percent text in the bar slot. Grok's single credits window is weekly, not session. Cursor uses Cursor Models on top and Third-Party underneath. Amp's subscription "other usage" window is Token Usage. Codex extra windows are Codex Spark Session / Codex Spark Weekly. Notion windows are Rolling and Monthly.
